...
#		x = True
    ...
    def retranslateUi(self, Main):
        ...
        self.OS_CB.setItemText(0, _translate("Main", "Linux/x86", None))
        self.OS_CB.setItemText(1, _translate("Main", "Windows/x86", None))
        self.OS_CB.setItemText(2, _translate("Main", "BSD/x86", None))
        self.OS_CB.setItemText(3, _translate("Main", "FreeBSD/mips", None))
        self.OS_CB.setItemText(4, _translate("Main", "Linux/ARM", None))
        self.OS_CB.setItemText(5, _translate("Main", "Linux/MIPS", None))
        self.OS_CB.setItemText(6, _translate("Main", "Linux/PPc", None))
